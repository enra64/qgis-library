...
call_layer_uri = filename_to_uri("/home/arne/Documents/git-repos/ubiquitous-systems/generated/cdr-converted/calls.csv")
...
def __show_movement(user_id: str, date: str):
    csv_data = read_csv_file(call_layer_uri)
